...
using MagicCountry_CountryAPI.Repository.IRepository;
...
namespace MagicCountry_CountryAPI.Repository
{
    public class UserRepository : IUserRepository
    {
        ...
        {
            _db = db;
            seceretKey = configuration.GetValue<string>("ApiSettings:Secret");
        }
