...
namespace ToueWebAPI.Migrations
{
    ...
    [Migration("20240703155256_SeedCountryTableWithCreateDate")]
    partial class SeedCountryTableWithCreateDate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ToueWebAPI.Models.Country", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Contenent = "Asia",
                            CreatedDate = new DateTime(2024, 7, 3, 16, 52, 54, 480, DateTimeKind.Local).AddTicks(8007),
                        ...
                        new
                        {
                            Id = 2,
                            Contenent = "Europe",
                            CreatedDate = new DateTime(2024, 7, 3, 16, 52, 54, 480, DateTimeKind.Local).AddTicks(8205),
