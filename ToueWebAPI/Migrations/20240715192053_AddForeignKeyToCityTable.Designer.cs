...
namespace ToueWebAPI.Migrations
{
    ...
    [Migration("20240715192053_AddForeignKeyToCityTable")]
    partial class AddForeignKeyToCityTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ToueWebAPI.Models.Country", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Contenent = "Asia",
                            CreatedDate = new DateTime(2024, 7, 15, 20, 20, 52, 508, DateTimeKind.Local).AddTicks(1575),
                        ...
                        new
                        {
                            Id = 2,
                            Contenent = "Europe",
                            CreatedDate = new DateTime(2024, 7, 15, 20, 20, 52, 508, DateTimeKind.Local).AddTicks(1641),
